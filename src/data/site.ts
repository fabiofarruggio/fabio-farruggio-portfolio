...
export const featuredProjects = [
  ...
  {
    slug: 'find-work',
    eyebrow: 'PROYECTO PÚBLICO · HERRAMIENTAS',
    ...
    stats: ['Portable', 'Reproducible', 'Repositorio público'],
    url: 'https://github.com/fabiofarruggio/find-work-agent',
  },
  {
    slug: 'qa-framework-template',
    eyebrow: 'REPOSITORIO PÚBLICO · FRAMEWORK',
    name: 'QA Framework Template',
    shortName: 'QA Framework Template',
    description: 'Plantilla compartida para construir suites de calidad con convenciones claras, trazabilidad y una base fácil de reutilizar.',
    role: 'Arquitectura de pruebas · Convenciones',
    stack: 'TypeScript · Playwright · Vitest',
    stats: ['Base reutilizable', 'Contratos', 'CI'],
    url: 'https://github.com/fabiofarruggio/qa-framework-template',
  },
  {
    slug: 'quality-lab-app',
    eyebrow: 'REPOSITORIO PÚBLICO · LABORATORIO',
    name: 'Quality Lab App',
    shortName: 'Quality Lab App',
    description: 'Aplicación de laboratorio con datos sintéticos para probar flujos, límites de infraestructura y señales de calidad.',
    role: 'Laboratorio · Integración',
    stack: 'React · PostgreSQL · Docker Compose',
    stats: ['Datos sintéticos', 'Entorno reproducible', 'Health checks'],
    url: 'https://github.com/fabiofarruggio/quality-lab-app',
  },
  {
    slug: 'qa-agent-evals',
    eyebrow: 'REPOSITORIO PÚBLICO · EVALUACIÓN',
    name: 'QA Agent Evals',
    shortName: 'QA Agent Evals',
    description: 'Corpus y evaluaciones para observar selección, regresión y métricas sin convertir un replay local en una promesa de producción.',
    role: 'Evaluación · Métricas · Evidencia',
    stack: 'Node.js · Benchmarks · Evidence',
    stats: ['Corpus versionado', 'Métricas honestas', 'Offline'],
...
export const career = [
  { period: 'ACTUAL', title: 'QA Automation & Quality Engineering', detail: 'Liderazgo técnico · KIU System Solutions', link: social.linkedin },
...
export const pages: Page[] = [
  ...
  { slug: 'trayectoria', eyebrow: 'Trayectoria / 03', title: 'Liderar calidad es crear capacidad en otros.', intro: 'En mi rol de liderazgo acompaño a los equipos para adoptar mejores prácticas de desarrollo de frameworks de tests automatizados y convertir la calidad en una responsabilidad compartida.', sections: [
    { title: 'Liderazgo técnico', text: 'Lidero equipos de QA y desarrollo en la definición de una forma de trabajo común: criterios claros, automatización mantenible, feedback útil y decisiones que se puedan explicar.' },
    { title: 'Frameworks que habilitan', text: 'Diseño y evoluciono frameworks de tests automatizados con convenciones, componentes reutilizables, datos controlados y herramientas que reducen la fricción para probar bien.' },
    { title: 'Ownership de calidad', text: 'Mi objetivo no es concentrar la calidad en un área. Ayudo a que cada equipo tome ownership de su producto, con las herramientas, el contexto y las prácticas necesarias para detectar problemas y sostenerlos en el tiempo.' },
    { title: 'QA Automation & Quality Engineering', text: 'Conecto estrategia de pruebas, automatización y criterio de ingeniería para que la calidad sea una propiedad del sistema completo: requisitos, código, datos, infraestructura, observabilidad y release.' },
